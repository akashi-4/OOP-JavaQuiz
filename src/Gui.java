...
public class Gui extends Potrivia implements ActionListener{
    ...
    */
    ...
    /**
     * Campo de texto para exibir a pontuação.
     */
    private JTextField pontuacao = new JTextField();
    /**
     ...
     */
    private int indGUI = 0;
    /**
     * Lista de perguntas respondidas corretamente.
     */
    private ArrayList<Pergunta> perguntCertas = new ArrayList<Pergunta>(5);
    /**
     * Lista de perguntas respondidas incorretamente.
     */
    private ArrayList<Pergunta> perguntErradas = new ArrayList<Pergunta>(5);
    /**
     * Lista de todas as perguntas do jogo.
     */
    private ArrayList<Pergunta> perguntas = new ArrayList<Pergunta>(5);
    /**
     * Lista de respostas do jogador.
     */
    private ArrayList<String> arrDeResposta = new ArrayList<String>(5);
    /**
     ...
     */
    private ArrayList<Integer> pontuacoes = new ArrayList<>();
    ...
    protected void setGui(ArrayList<String> shuffleArray){
        ...
        botaoOpc1.setBounds(11, 150, 100, 100);
        ...
        botaoOpc2.setBounds(11, 250, 100, 100);
        ...
        botaoOpc3.setBounds(11, 350, 100, 100);
        ...
        botaoOpc4.setBounds(11, 450, 100, 100);
        ...
        answer_Alt1.setBounds(125, 150, 503, 100);
        ...
        answer_Alt2.setBounds(125, 250, 503, 100);
        ...
        answer_Alt3.setBounds(125, 350, 503, 100);
        ...
        answer_Alt4.setBounds(125, 450, 503, 100);
        ...
        pontuacao.setBounds(0, 560, 650, 58);
        pontuacao.setBackground(corBotao);
        pontuacao.setForeground(corTexto);
        pontuacao.setFont(new Font("Arial", Font.CENTER_BASELINE, 15));
        pontuacao.setBorder(BorderFactory.createBevelBorder(1));
        pontuacao.setHorizontalAlignment(JTextField.CENTER);
    ...
    */
    private void nextQuestion(int index, ArrayList<Pergunta> perguntas, ArrayList<String> shuffleArray){
        ...
        pontuacao.setText("");
        // Define o texto da pergunta e o índice da pergunta
        questionIndex.setText("Pergunta " + (index+1) + " de 5");
        questionText.setText("\n\t" + perguntas.get(index).getPergunta());
        switch (shuffleArray.size()) {
            // Se houver 2 opções de resposta disponíveis para a pergunta, liga somente os 2 botões necessários e o texto correspondente
            case 2:
                ...
                break;
            // Se houver 3 opções de resposta disponíveis para a pergunta, liga somente os 3 botões necessários e o texto correspondente
            case 3:
                frame.add(answer_Alt1);
                frame.add(answer_Alt2);
                ...
                botaoOpc4.setVisible(false);
                break;
            //  Se houver 4 opções de resposta disponíveis para a pergunta, liga somente os 4 botões necessários e o texto correspondente
            case 4:
                frame.add(answer_Alt1);
                frame.add(answer_Alt2);
                frame.add(answer_Alt3);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==botaoOpc1){
            ...
            if(answer_Alt1.getText().equals(perguntas.get(indGUI).getResposta()) || answer_Alt1.getText().equals(perguntas.get(indGUI).getResposta2())	){
                ...
                pontuacao.setText("Pontos ganhos: " + perguntas.get(indGUI).calculaPontos() + " pontos");
            }
            else{
                perguntErradas.add(perguntas.get(indGUI));
                pontuacao.setText("Pontos ganhos: 0 pontos");
            }
        }
        // Verifica se a opção 2 foi selecionada
        ...
        // Verifica se a opção 3 foi selecionada
        ...
        // Verifica se a opção 4 foi selecionada
    ...
    */
    private void salvarDados(ArrayList<Pergunta> perguntasCertas, ArrayList<Pergunta> perguntasErradas, String username, LocalDateTime data, String formataData){
        ...
        try {
            ...
            dStore.setUsername(sigla);
            dStore.setData(data);
            dStore.setPerguntasCertas(perguntasCertas);
            dStore.setPerguntasErradas(perguntasErradas);
    ...
    */
    private void carregarDados(File datFile){
        try {
            ...
            usernames.add(dStore.getUsername());
            // Calcula a pontuação se houver perguntas certas, caso contrário, adiciona 0
            if (dStore.getPerguntasCertas().size() > 0){
                pontuacoes.add(calcularPontuacao(dStore.getPerguntasCertas()));
            }else{
                pontuacoes.add(0);
            }
    ...
    */
    private void top3(String username){
        ...
        for (int i = 0; i < usernames.size(); i++) {
            ...
            if (usernames.get(i).equals(username) && (usernames.size() > 2)){
            ...
            else if (usernames.get(i).equals(username) && (usernames.size() == 2)){
                JOptionPane.showMessageDialog(frame,"Top 3:\n1º - " + usernames.get(0) + " - " + pontuacoes.get(0) + " pontos\n2º - " + usernames.get(1) + " - " + pontuacoes.get(1) + " pontos\n" + "Sua posição:\n" + (i+1) + "º - "+ usernames.get(i) +" - "+ pontuacoes.get(i) + " pontos");
                return;
            }else if(usernames.get(i).equals(username) && (usernames.size() == 1)){
                JOptionPane.showMessageDialog(frame,"Top 3:\n1º - " + usernames.get(0) + " - " + pontuacoes.get(0) + " pontos\n" + "Sua posição:\n" + (i+1) + "º - "+ usernames.get(i) +" - "+ pontuacoes.get(i) + " pontos"); 
            }
        }
    }
